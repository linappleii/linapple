...
TEST_CASE("Keyboard Peripheral: Strobe and Latch Behavior") {
  ...
  uint8_t caps = 0;
  keyboard_peripheral.command(instance, keyb_cmd_set_caps, &caps, 1);
  KeyboardEvent_t ev = {'a', 1, 0, 0, 0, 0};
...
TEST_CASE("Keyboard Peripheral: Multiple keys and ASCII 0") {
  ...
  uint8_t caps = 0;
  keyboard_peripheral.command(instance, keyb_cmd_set_caps, &caps, 1);
  KeyboardEvent_t evA = {'a', 1, 0, 0, 0, 0};
  ...
  // 2. Press 'B'
  KeyboardEvent_t evB = {'b', 1, 0, 0, 0, 0};
  ...
  // 5. Test ASCII 0 (Ctrl-@)
  KeyboardEvent_t evCtrlAt = {0, 1, 0, 0, 0, 0};
  keyboard_peripheral.command(instance, keyb_cmd_event, &evCtrlAt,
                              sizeof(evCtrlAt));
...
TEST_CASE("Keyboard Peripheral: International character safety") {
  ...
  KeyboardEvent_t ev = {0x7B, 1, 0, 0, 0, 0};
  keyboard_peripheral.command(instance, keyb_cmd_event, &ev, sizeof(ev));
...
TEST_CASE("Keyboard Peripheral: Ctrl+@ (NUL) handling") {
  ...
  KeyboardEvent_t ev = {0x00, 1, 0, 0, 0, 0};
  keyboard_peripheral.command(instance, keyb_cmd_event, &ev, sizeof(ev));
