...
static inline auto H(UINT4 x, UINT4 y, UINT4 z) -> UINT4 { return (x ^ y ^ z); }
...
static const UINT4 md5_initstate[MD5_STATE_SIZE] = {MD5_INIT_0, MD5_INIT_1,
                                                    MD5_INIT_2, MD5_INIT_3};
...
// NOLINTEND(cppcoreguidelines-owning-memory, cppcoreguidelines-avoid-c-arrays,
