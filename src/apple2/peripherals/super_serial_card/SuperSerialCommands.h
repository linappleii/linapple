...
} SuperSerialStopBits_e;

typedef struct {
  SuperSerialBaudRate_e baud_rate;
  SuperSerialFirmwareMode_e firmware_mode;
  SuperSerialStopBits_e stop_bits;
  SuperSerialByteSize_e byte_size;
