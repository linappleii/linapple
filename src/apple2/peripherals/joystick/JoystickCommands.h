...
typedef enum {
  JOY_CMD_SET_AXIS = PERIPHERAL_SUBSYSTEM_JOYSTICK | 0x0000,
  JOY_CMD_SET_BUTTON = PERIPHERAL_SUBSYSTEM_JOYSTICK | 0x0001,
  JOY_CMD_SET_TRIM = PERIPHERAL_SUBSYSTEM_JOYSTICK | 0x0002,
  JOY_CMD_RESET = PERIPHERAL_SUBSYSTEM_JOYSTICK | 0x0003,
  JOY_CMD_SET_CONFIG = PERIPHERAL_SUBSYSTEM_JOYSTICK | 0x0004
} JoystickCmd_e;

typedef enum {
  JOY_QUERY_CONFIG = PERIPHERAL_SUBSYSTEM_JOYSTICK | 0x0001,
  JOY_QUERY_EXIT_EVENT = PERIPHERAL_SUBSYSTEM_JOYSTICK | 0x0002
} JoystickQuery_e;
